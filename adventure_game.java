            ...
            public static void main (String[] args)
            {
             ...
             do {
                   ...
                   if(leftRight == 1)
                   {
                        ...
                        System.out.println("but its blocked by a door with a code ");
                        System.out.println("You look close at it and it says");
                        ...
                        Scanner scan =new Scanner(System.in);
                           ...
                           System.out.println("Now choose any of these options?");
                           System.out.println();
                           ...
                           System.out.println("Division (4)");
                             ...
                             class Meth1
                             {
                              ...
                              Meth1 mani =new Meth1();
                              if(selection == 1)
                              {
                                c=mani.add(a,b);
                                System.out.println("Your answer is "+c+ " and that is correct opening up the door");
                              }
                              else if(selection==2)
                              {
                                c=mani.sub(a,b); 
                            ...
                            System.out.println("the Dragon is sleeping but suddenly wakes up");
                ...
                if (attack3 == 2)
                {
                 ...
                 playerAttack = input.nextInt();
                   ...
                   if (leftRight == 2)
                   {
                           ...
                           System.out.println("You hear snoring. When you cross a corner you find a huge door");
                           System.out.println("The door has a lock on it and a code");
                           System.out.println();
                          ...
                          else if(selection==4)
                          {
                            ...
                            System.out.println("You see the dragon inside of the cave");
